...
describe('Engagement closure', () => {
  ...
  new EngagementsService({ scoped: () => db } as never, {} as never, {} as never, workflow, {} as never, { assertEngagement: jest.fn(), engagementScope: jest.fn().mockReturnValue({}) } as never, registry, {} as never);
